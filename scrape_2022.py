...
url_base = "https://www.pdga.com/players/stats?Year=2022&player_Class=1&Gender=Male&Bracket=MPO&continent=All&Country=All&StateProv=All&page="
...
for x in url_list:     
    #url = 'https://www.pdga.com/players/stats?Year=2022&player_Class=All&Gender=All&Bracket=All&continent=All&Country=All&StateProv=All&page=' + str(x)
    url = x
    #url_read.append(url)
...
all_fields.to_csv("data/all_fields_2022_pro.csv")
