...
all_players = pd.read_csv("data/all_fields_2022_pro.csv")
...
# Filter to top 100 Male Pro Players in 2022
...
male_pros_2022 = male_pros[male_pros["year"]==2022].sort_values(by = ['rating'],ascending = False)
male_pros_2022_t100 = male_pros_2022.drop_duplicates(subset = ['pdga_number']).head(100)



#Merge Top Players with Events Details

top_w_place = male_pros_2022_t100.merge(event_details, how = 'left',
                                        on = 'pdga_number')
